...
class FixedIncomeScreen extends ConsumerStatefulWidget {
  const FixedIncomeScreen({super.key});

  @override
  ConsumerState<FixedIncomeScreen> createState() => _FixedIncomeScreenState();
}

class _FixedIncomeScreenState extends ConsumerState<FixedIncomeScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final result = await api.get('fixedIncome/getInstruments');
      setState(() {
