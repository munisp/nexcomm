...
class MarketMakerScreen extends ConsumerStatefulWidget {
  const MarketMakerScreen({super.key});

  @override
  ConsumerState<MarketMakerScreen> createState() => _MarketMakerScreenState();
}

class _MarketMakerScreenState extends ConsumerState<MarketMakerScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final result = await api.get('marketMaker/getPerformance');
      setState(() {
