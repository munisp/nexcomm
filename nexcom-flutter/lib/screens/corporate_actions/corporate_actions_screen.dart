...
class CorporateActionsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CorporateActionsScreen> createState() => _CorporateActionsScreenState();
}

class _CorporateActionsScreenState extends ConsumerState<CorporateActionsScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final result = await api.get('corporateActions/getActions');
      setState(() {
