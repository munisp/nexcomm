...
class DerivativesScreen extends ConsumerStatefulWidget {
  const DerivativesScreen({super.key});

  @override
  ConsumerState<DerivativesScreen> createState() => _DerivativesScreenState();
}

class _DerivativesScreenState extends ConsumerState<DerivativesScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final result = await api.get('derivatives/getContracts');
      setState(() {
