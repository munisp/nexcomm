  ...
  return (
    <div className="border-y border-slate-800 bg-slate-900/40">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-14">
        ...
        <div className="relative rounded-2xl overflow-hidden border border-slate-700/60 shadow-2xl bg-slate-950"
    ...
    <div className="min-h-screen bg-slate-950 text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-slate-900/80 border border-slate-700/60 rounded-2xl p-6 backdrop-blur-sm">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-400">Nigerian Ginger · Spot</div>
                  </div>
                </div>
              ...
              <div className="mb-4">
                ...
                <div className="text-xs text-slate-500 mt-0.5">per kilogram · NGN</div>
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-slate-700/50 space-y-3">
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-2 w-full py-2 rounded-lg bg-slate-800 hover:bg-slate-700 text-emerald-400 text-xs font-medium transition-colors"
                >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
          ...
          {ONBOARDING_STEPS.map((s, i) => (
            <div key={s.step} className="flex items-center flex-shrink-0">
              ...
              >
                ...
                <span className="text-xs text-slate-300 font-medium whitespace-nowrap">{s.step}. {s.title.split(" ").slice(0, 2).join(" ")}</span>
              </button>
        ...
        {expandedOnboarding !== null && (() => {
          ...
          return (
            <div className="bg-slate-900/60 border border-slate-700/50 rounded-2xl p-6 mb-8 transition-all">
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <Badge className="text-xs bg-slate-700 text-slate-300 border-slate-600">{s.badge}</Badge>
                      </div>
                      <p className="text-sm text-slate-400">{s.subtitle}</p>
                    </div>
                  </div>
                  <p className="text-slate-300 leading-relaxed mb-4">{s.description}</p>
          ...
          {ONBOARDING_STEPS.map((s, i) => (
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <ChevronDown className={`w-4 h-4 text-slate-500 flex-shrink-0 transition-transform ${expandedOnboarding === i ? "rotate-180" : ""}`} />
              </div>
              <div className="flex items-center justify-between">
                <Badge className="text-xs bg-slate-800 text-slate-400 border-slate-700">{s.badge}</Badge>
              ...
              {TRADE_DEMO_STEPS.map((step, i) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className={`text-sm font-semibold ${tradeDemoStep === i ? "text-white" : "text-slate-300"}`}>
                        {step.screen}
                      </div>
                      <div className="text-xs text-slate-400 truncate">{step.action}</div>
                    </div>
                  </div>
                </button>
              ))}
            ...
            <div className="sticky top-6">
              <div className="bg-slate-900 border border-slate-700/60 rounded-2xl overflow-hidden">
                ...
                <div className="bg-slate-800/80 border-b border-slate-700/50 px-4 py-3 flex items-center gap-2">
                  ...
                  <span className="ml-3 text-xs text-slate-400 font-mono">nexcom.ng / {TRADE_DEMO_STEPS[tradeDemoStep].screen.toLowerCase().replace(/ /g, "-")}</span>
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <div>
                      <div className="text-xs text-slate-400">Step {tradeDemoStep + 1} of {TRADE_DEMO_STEPS.length}</div>
                  ...
                  {/* Highlight */}
                  <div className="bg-slate-800 border border-slate-700 rounded-xl p-3 font-mono text-sm text-emerald-300">
                    ...
                    {TRADE_DEMO_STEPS.map((_, i) => (
                      <button
                        ...
                        className={`h-1.5 rounded-full transition-all ${
                          i === tradeDemoStep ? "w-6 bg-emerald-400" : i < tradeDemoStep ? "w-1.5 bg-emerald-700" : "w-1.5 bg-slate-700"
                        }`}
                      />
                    ))}
                  </div>
      ...
      <div className="border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
          ...
          {/* Fee breakdown */}
          <div className="mt-8 bg-slate-900/60 border border-slate-700/50 rounded-2xl p-6">
      ...
      {/* ── CTA ──────────────────────────────────────────────────────────── */}
      <div className="border-t border-slate-800 bg-gradient-to-br from-emerald-950/40 to-slate-950">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link href="/trade">
              <Button variant="outline" className="border-slate-600 text-slate-300 hover:text-white text-base px-8 py-3 h-auto gap-2">
