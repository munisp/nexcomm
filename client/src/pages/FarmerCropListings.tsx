    ...
    <div className="min-h-screen bg-gradient-to-b from-green-950 to-slate-950 flex flex-col max-w-md mx-auto">
      ...
      <div className="p-4 flex items-center gap-3 border-b border-border">
        ...
        <div className="flex-1">
          ...
          <p className="text-muted-foreground text-xs">Step 4 of 4</p>
        </div>
        <Button
          size="sm"
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-3">
                <div className="space-y-1">
                  <Label className="text-muted-foreground text-xs">Farm *</Label>
                  <select
                    value={form.farmId}
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className="space-y-1">
                    <Label className="text-muted-foreground text-xs">Variety</Label>
                    <Input
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="space-y-1">
                    <Label className="text-muted-foreground text-xs">Quantity (kg) *</Label>
                    <Input
                      type="number"
                      min="1"
                  ...
                  <div className="space-y-1">
                    <Label className="text-muted-foreground text-xs">Price/kg (₦) *</Label>
                    <Input
                      type="number"
                      min="1"
                      step="0.01"
                ...
                <div className="space-y-1">
                  <Label className="text-muted-foreground text-xs">Expected Harvest Date *</Label>
                  <Input
                    type="date"
                ...
                {form.quantityKg && form.askingPricePerKg && (
                  <div className="bg-green-950/40 border border-green-800/40 rounded-lg p-3 flex items-center justify-between">
                    <p className="text-muted-foreground text-xs">Estimated total value</p>
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        ...
                        {listing.variety && <p className="text-muted-foreground text-xs">{listing.variety}</p>}
                      </div>
