...
export default function ForexScreen() {
  ...
  const { data, isLoading, refetch } = trpc.forex.getRates.useQuery(
    undefined,
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          <View style={styles.cardGrid}>
            <View style={styles.statCard}>
              <Text style={styles.statValue}>₦{(data as any)?.['usdNgn'] ?? '—'}</Text>
              <Text style={styles.statLabel}>USD/NGN</Text>
            </View>
            <View style={styles.statCard}>
              <Text style={styles.statValue}>₦{(data as any)?.['eurNgn'] ?? '—'}</Text>
              <Text style={styles.statLabel}>EUR/NGN</Text>
            </View>
            <View style={styles.statCard}>
              <Text style={styles.statValue}>₦{(data as any)?.['gbpNgn'] ?? '—'}</Text>
              <Text style={styles.statLabel}>GBP/NGN</Text>
            </View>
            <View style={styles.statCard}>
              <Text style={styles.statValue}>₦{(data as any)?.['volume'] ?? '—'}</Text>
