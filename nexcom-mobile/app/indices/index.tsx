...
export default function IndicesScreen() {
  ...
  const { data, isLoading, refetch } = trpc.indices.getAll.useQuery(
    undefined,
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Commodity Indices</Text>
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          <View style={styles.cardGrid}>
            <View style={styles.statCard}>
              <Text style={styles.statValue}>{(data as any)?.['naxi'] ?? '—'}</Text>
              <Text style={styles.statLabel}>NAXI</Text>
            </View>
            <View style={styles.statCard}>
              <Text style={styles.statValue}>{(data as any)?.['nggi'] ?? '—'}</Text>
              <Text style={styles.statLabel}>NGGI</Text>
            </View>
            <View style={styles.statCard}>
              <Text style={styles.statValue}>{(data as any)?.['aoxi'] ?? '—'}</Text>
              <Text style={styles.statLabel}>AOXI</Text>
            </View>
            <View style={styles.statCard}>
              <Text style={styles.statValue}>{(data as any)?.['wacci'] ?? '—'}</Text>
              <Text style={styles.statLabel}>WACCI</Text>
            </View>
