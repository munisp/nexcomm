...
/**
 * NEXCOM Mobile — Trade / Order Book Screen
 * Mirrors the PWA Trade / Order Book page with full API connectivity.
 */
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        <Text style={styles.title}>Trade / Order Book</Text>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.cardBody}>
          Place and manage orders across all commodity instruments with real-time order book depth.
        </Text>
      </View>
