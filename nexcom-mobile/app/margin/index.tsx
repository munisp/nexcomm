...
export default function MarginScreen() {
  ...
  const { data, isLoading, refetch } = trpc.margin.getAccount.useQuery(
    undefined,
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Margin Account</Text>
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          <View style={styles.cardGrid}>
            <View style={styles.statCard}>
              <Text style={styles.statValue}>₦{(data as any)?.['balance'] ?? '—'}</Text>
              <Text style={styles.statLabel}>Balance</Text>
            </View>
            <View style={styles.statCard}>
              <Text style={styles.statValue}>₦{(data as any)?.['usedMargin'] ?? '—'}</Text>
              <Text style={styles.statLabel}>Used Margin</Text>
            </View>
            <View style={styles.statCard}>
              <Text style={styles.statValue}>₦{(data as any)?.['freeMargin'] ?? '—'}</Text>
              <Text style={styles.statLabel}>Free Margin</Text>
            </View>
            <View style={styles.statCard}>
              <Text style={styles.statValue}>{(data as any)?.['marginLevel'] ?? '—'}%</Text>
              <Text style={styles.statLabel}>Margin Level</Text>
            </View>
