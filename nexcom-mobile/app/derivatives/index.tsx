...
export default function DerivativesScreen() {
  ...
  const { data, isLoading, refetch } = trpc.derivatives.getContracts.useQuery(
    undefined,
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          <View style={styles.cardGrid}>
            <View style={styles.statCard}>
              <Text style={styles.statValue}>{(data as any)?.['openContracts'] ?? '—'}</Text>
            ...
            <View style={styles.statCard}>
              <Text style={styles.statValue}>₦{(data as any)?.['pnl'] ?? '—'}</Text>
              <Text style={styles.statLabel}>P&L</Text>
            </View>
            <View style={styles.statCard}>
              <Text style={styles.statValue}>₦{(data as any)?.['marginUsed'] ?? '—'}</Text>
