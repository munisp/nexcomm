 ...
 * Mirrors the PWA Markets & Instruments page with full API connectivity.
 */
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        <Text style={styles.title}>Markets & Instruments</Text>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.cardBody}>
          Browse all available commodity markets, instruments, and contract specifications.
        </Text>
      </View>
