...
/**
 * NEXCOM Mobile — TOTP / 2FA Setup Screen
 * Mirrors the PWA TOTP / 2FA Setup page with full API connectivity.
 */
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        <Text style={styles.title}>TOTP / 2FA Setup</Text>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.cardBody}>
          Set up two-factor authentication using TOTP (Google Authenticator / Authy).
        </Text>
      </View>
