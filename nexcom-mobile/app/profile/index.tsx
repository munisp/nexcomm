...
/**
 * NEXCOM Mobile — Profile & Settings Screen
 * Mirrors the PWA Profile & Settings page with full API connectivity.
 */
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.cardBody}>
          Manage your profile, KYC documents, linked bank accounts, and notification preferences.
        </Text>
      </View>
