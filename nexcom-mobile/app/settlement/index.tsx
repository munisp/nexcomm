...
export default function SettlementScreen() {
  ...
  const { data, isLoading, refetch } = trpc.settlement.getSettlements.useQuery(
    undefined,
      ...
      {isLoading ? (
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          <View style={styles.cardGrid}>
            ...
            <View style={styles.statCard}>
              <Text style={styles.statValue}>{(data as any)?.['completedToday'] ?? '—'}</Text>
              <Text style={styles.statLabel}>Completed Today</Text>
            </View>
            <View style={styles.statCard}>
              <Text style={styles.statValue}>₦{(data as any)?.['totalValue'] ?? '—'}</Text>
              <Text style={styles.statLabel}>Total Value</Text>
            </View>
            <View style={styles.statCard}>
              <Text style={styles.statValue}>{(data as any)?.['failed'] ?? '—'}</Text>
