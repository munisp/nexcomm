...
export default function WorkbenchScreen() {
  ...
  const { data, isLoading, refetch } = trpc.workbench.getBusinesses.useQuery(
    undefined,
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          <View style={styles.cardGrid}>
            <View style={styles.statCard}>
              <Text style={styles.statValue}>{(data as any)?.['businesses'] ?? '—'}</Text>
              <Text style={styles.statLabel}>Businesses</Text>
            </View>
            <View style={styles.statCard}>
              <Text style={styles.statValue}>{(data as any)?.['activePlans'] ?? '—'}</Text>
              <Text style={styles.statLabel}>Active Plans</Text>
            </View>
            <View style={styles.statCard}>
              <Text style={styles.statValue}>{(data as any)?.['cropReports'] ?? '—'}</Text>
              <Text style={styles.statLabel}>Crop Reports</Text>
            </View>
            <View style={styles.statCard}>
              <Text style={styles.statValue}>{(data as any)?.['loans'] ?? '—'}</Text>
