...
/**
 * NEXCOM Mobile — Push Notification Settings Screen
 * Mirrors the PWA Push Notification Settings page with full API connectivity.
 */
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.cardBody}>
          Configure push notification preferences for price alerts, trade confirmations, and system events.
        </Text>
      </View>
