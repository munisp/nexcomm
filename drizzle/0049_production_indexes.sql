-- Migration 0049: Production indexes for all high-traffic tables
-- Generated from drizzle/schema-indexes.ts PRODUCTION_INDEX_SQL
-- Apply these indexes for production performance on PostgreSQL 16
