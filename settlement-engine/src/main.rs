...
use settlement::{SettlementEngine, SettlementStats};
...
async fn prometheus_metrics(state: web::Data<AppState>) -> HttpResponse {
    let engine = state.engine.read().await;
    let stats = engine.stats();
    let body = format!(
        "# HELP nexcom_settlement_pending Pending settlements in queue\n\
         # TYPE nexcom_settlement_pending gauge\n\
         nexcom_settlement_pending {{service=\"settlement-engine\"}} {}\n\
         # HELP nexcom_settlement_completed_total Completed settlements\n\
         # TYPE nexcom_settlement_completed_total counter\n\
         nexcom_settlement_completed_total {{service=\"settlement-engine\"}} {}\n\
         # HELP nexcom_settlement_failed_total Failed settlements\n\
         # TYPE nexcom_settlement_failed_total counter\n\
         nexcom_settlement_failed_total {{service=\"settlement-engine\"}} {}\n",
        stats.pending,
        stats.completed,
        stats.failed,
    );
