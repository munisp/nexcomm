/**
 * NEXCOM Exchange — corporateActionsRouter Unit Tests
 *
...
describe("corporateActionsRouter", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it("router is defined", () => {
    expect(corporateActionsRouter).toBeDefined();
  });
  it("has procedures", () => {
    expect(Object.keys(corporateActionsRouter)).not.toHaveLength(0);
  });
});
