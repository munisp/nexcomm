/**
 * NEXCOM Exchange — pushNotificationsRouter Unit Tests
 *
...
describe("pushNotificationsRouter", () => {
  ...
  it("router is defined", () => {
    expect(pushNotificationsRouter).toBeDefined();
  });
  it("has procedures", () => {
    expect(Object.keys(pushNotificationsRouter)).not.toHaveLength(0);
  });
});
